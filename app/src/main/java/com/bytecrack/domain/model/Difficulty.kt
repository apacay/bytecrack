...
enum class Difficulty(
    ...
    HARD(digitCount = 3, radix = 16, pointMultiplier = 3, timeBonusMultiplier = 4, baseAttempts = 10, rewardAdSeconds = 90L, rewardAdBreachExtension = 5, rewardAdBreachThreshold = 6, displayName = "Hard"),
    VERY_HARD(digitCount = 4, radix = 10, pointMultiplier = 2, timeBonusMultiplier = 2, baseAttempts = 10, rewardAdSeconds = 90L, rewardAdBreachExtension = 5, rewardAdBreachThreshold = 6, displayName = "Very Hard"),
